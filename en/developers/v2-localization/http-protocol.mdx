---
title: "V2 HTTP protocol"
description: "Use the V2 visual localization module HTTP endpoints, request parameters, and response formats."
hidden: true
---
...
### Get Local Map List (Backend) (Get the background map list, not recommended)
...
### Get the local map list (recommended)
